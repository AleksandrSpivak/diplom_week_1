# Звіт про дослідження: Порівняльний аналіз pretrained моделей комп'ютерного зору для виявлення бізнес-релевантних об'єктів та ситуацій у візуальному контенті соціальних мереж
